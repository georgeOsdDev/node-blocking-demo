...
module.exports = async function (context, myTimer) {
    context.log(`[Timer2(blocking) start] ${context.invocationId}, ${new Date().toISOString()}`);
    ...
    for (const dir of directories) {
        ...
        if (stat.isDirectory()){
            ...
            for (const file of files) {
                ...
                // context.log(`[Timer2] ${context.invocationId}, ${FROM_DIR}/${dir}/${file}, ${stat2}, ${new Date().toISOString()}`);
            }
        }
    }
    context.log(`[Timer2(blocking) end] ${context.invocationId}, ${coppied}, ${new Date().toISOString()}`);
};
